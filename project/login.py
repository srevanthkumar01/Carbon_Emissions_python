...
def Log():
    ...
    # Top Frame
    top_frame = Label(Login, text='Login To CO2 Emissions system', font=('Cosmic', 25, 'bold'), bg='WHITE',
                      relief='groove', padx=500, pady=30)
        ...
        if username_entry.get() == '':
            ...
            if results:
                ...
                label = tk.Label(result, text='Hi ' + username + '\nThank You For Using Our System !!!!',
                                 font=('Arial', 12, 'bold'), bg='white', fg='green').place(relx=0.5, rely=0.5,anchor=CENTER)
    ...
    username_entry = tk.Entry(frame, font=('calibre', 10, 'normal'), justify='center', bg='WHITE')
    username_entry.bind('<Return>', Search)
    password_entry = tk.Entry(frame, font=('calibre', 10, 'normal'), show='*', justify='center', bg='WHITE')
    password_entry.bind('<Return>', Search)

    # Button that will call the submit function
    submit = tk.Button(frame, text='Login', command=Search, width="10", bd='3', font=('Times', 12, 'bold'), bg='BLACK',
                       fg='white', relief='groove', justify='center', pady='5')
    ...
    Quit = tk.Button(Login, text="Quit", width="10", command=Login.destroy, bd='3', font=('Times', 12, 'bold'),
                     bg='white', fg='black', relief='groove', justify='center', pady='5')
